        ...
        Eigen::Vector3d toAxisAngle(const Eigen::Matrix3d & m) {
            ...
            && (fabs(m(1, 2) -m(2, 1))< epsilon)) {
                ...
                && (fabs(m(0, 0) +m(1, 1) +m(2, 2) -3) < epsilon2)) {
                    ...
                    return Eigen::Vector3d(0, 0, 0); // axisAngle(0,1,0,0); // zero angle, arbitrary axis
                }
                ...
                return Eigen::Vector3d(angle*x, angle*y, angle*z); // axisAngle(angle,x,y,z); // return 180 deg rotation
            }
            ...
            y = (m(0, 2) - m(2, 0))/s;
            z = (m(1, 0) - m(0, 1))/s;
            return Eigen::Vector3d(angle*x, angle*y, angle*z); // axisAngle(angle,x,y,z);
        }
